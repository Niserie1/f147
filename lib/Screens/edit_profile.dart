...
import 'package:profildenemesi/Screens/settings_screen.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        child: GestureDetector(
          onTap: () {
            FocusScope.of(context).unfocus(); // Bunu kullanarak textfieldi diselected edebildik..
          },
          child: ListView(
            children: [
              SizedBox(height: 15),
              ...
              buildTextField("Hakkında","Hayvanları çok seviyorum ve köpeğim benim ailem gibi ona çok değer veriyorum.  Onunla düzenli ",false),
              SizedBox(height: 2),
              Row(
