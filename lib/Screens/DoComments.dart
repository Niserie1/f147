...
import 'package:profildenemesi/Screens/CommentList.dart';
...
class _DoCommentState extends State<DoComment> {
  ...
  void viewCommentsPage() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => CommentsListScreen(comments: comments)),
    );
  }
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text('Puanla: ',style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold),),
                  Slider(
                      value: rating,
                      min: 0,
                      max: 5,
            ...
            SizedBox(height: 10),
            ElevatedButton(onPressed: addComment, child: Text('Yorum yap'),
              style: ElevatedButton.styleFrom(backgroundColor: Colors.orange),
            ),
            SizedBox(height: 10),
            ElevatedButton(onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => CommentsListScreen(comments: [],)),
              );
            },
            ...
            SizedBox(height: 10),
            ElevatedButton(onPressed: addComment, child: Text('Vazgeç'),
              style: ElevatedButton.styleFrom(backgroundColor: Colors.orange),
            ),
          ],
        ),
